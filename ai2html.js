...
function main() {
  ...
  var defaultSettings = {
    ...
    fonts: [
      ...
      {
        aifont: 'Source Sans Variable Light',
        family: 'Source Sans Pro,helvetica,sans-serif',
        weight: '100',
        style: '',
        vshift: '8%',
      ...
      {
        aifont: 'Source Sans Variable Regular',
        family: 'Source Sans Pro,helvetica,sans-serif',
        weight: '400',
        style: '',
        vshift: '8%',
      ...
      {
        aifont: 'Source Sans Variable Semibold',
        family: 'Source Sans Pro,helvetica,sans-serif',
        weight: '500',
        style: '',
        vshift: '8%',
      ...
      {
        aifont: 'Source Sans Variable Bold',
        family: 'Source Sans Pro,helvetica,sans-serif',
        weight: '700',
        style: '',
        vshift: '8%',
  ...
  function assignBreakpointsToArtboards(breakpoints) {
    ...
    forEach(breakpoints, function(breakpoint) {
      ...
      for (var i = 0; i < abArr.length; i++) {
        abInfo = abArr[i];
        if (
          abInfo.effectiveWidth <= breakpoint.upperLimit &&
  ...
  function getClippedTextFramesByArtboard(ab, masks) {
    ...
    forEach(masks, function(o) {
      ...
      var texts = filter(o.items, function(item) {
  ...
  function getOutputImagePixelRatio(width, height, format, doubleres) {
    ...
    if (preferDouble && width < 945) {
      // assume wide images are desktop-only
      // use single res if image might run into mobile browser limits
      if (
        ((format == 'png' || format == 'png24') && pixels > maxPngSize) ||
  ...
  function generateArtboardDiv(ab, breakpoints, settings) {
    ...
    html +=
      ...
      '"';
    html +=
      ' data-aspect-ratio="' + roundTo(abBox.width / abBox.height, 3) + '"';
